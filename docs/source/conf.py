# -*- coding: utf-8 -*-
#
# datalad_redcap documentation build configuration file, created by
        ...
        try:
            subprocess.run(
                args=[setup_py_path, 'build_manpage',
                     '--cmdsuite', 'datalad_redcap:command_suite',
                     '--manpath', abspath(opj(
...
# built documents.
version = datalad_redcap.__version__
release = version
